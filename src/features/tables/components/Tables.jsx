...
export const Tables = () => {
    ...
    return (
        /* pb-24 y mb-10 añadidos para corregir el scroll del final */
        <div className="p-4 md:p-8 pb-24 md:pb-32 max-w-7xl mx-auto min-h-screen overflow-y-auto">
            {/* Header */}
            ...
            {/* Contenedor de Datos */}
            <div className="bg-white rounded-[2rem] md:rounded-[3rem] shadow-2xl border border-[#EADDCA]/50 overflow-hidden mb-10">
            ...
            <TableModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} table={selectedTable} />
        </div>
    );
};